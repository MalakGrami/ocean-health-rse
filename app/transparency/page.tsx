...
export default function TransparencyPage() {
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <section className="mb-8 sm:mb-12 bg-gradient-to-br from-ocean-blue/5 to-sea-green/5 p-4 sm:p-6 md:p-8 rounded-2xl border-2 border-ocean-blue/20">
        <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 text-center">Alignement avec NUMIH France</h2>
        <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 mb-3 sm:mb-4 text-center max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mt-4 sm:mt-6">
          <div className="text-center">
            <div className="font-bold text-ocean-blue mb-1 sm:mb-2 text-sm sm:text-base">RGPD</div>
            <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Architecture local-first = Conformité intrinsèque</p>
          </div>
          <div className="text-center">
            <div className="font-bold text-ocean-blue mb-1 sm:mb-2 text-sm sm:text-base">HDS</div>
            <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Réduction 40-60% charge hébergement</p>
          </div>
          <div className="text-center">
            <div className="font-bold text-ocean-blue mb-1 sm:mb-2 text-sm sm:text-base">RGESN</div>
            <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">96% conformité écoconception</p>
          </div>
        </div>
      </section>

      {/* Environmental */}
      <section className="mb-8 sm:mb-12 bg-gradient-to-br from-sea-green/10 to-ocean-blue/10 p-4 sm:p-6 md:p-8 rounded-2xl">
        <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
          <span className="text-lg sm:text-xl md:text-2xl font-bold text-sea-green px-2 sm:px-3 py-1 bg-white dark:bg-gray-800 rounded">Env.</span>
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold">Responsabilité Environnementale</h2>
        </div>
        <div className="space-y-3 sm:space-y-4">
          <div>
            <h3 className="text-lg sm:text-xl font-semibold mb-2">Empreinte Carbone Minimale</h3>
          ...
          <div>
            <h3 className="text-lg sm:text-xl font-semibold mb-2">Méthodologie de Calcul CO₂</h3>
      ...
      <section className="mb-8 sm:mb-12 bg-gradient-to-br from-ocean-blue/10 to-sea-green/10 p-4 sm:p-6 md:p-8 rounded-2xl">
        <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
          <span className="text-lg sm:text-xl md:text-2xl font-bold text-ocean-blue px-2 sm:px-3 py-1 bg-white dark:bg-gray-800 rounded">Acc.</span>
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold">Responsabilité Sociale</h2>
        </div>
        <div className="space-y-3 sm:space-y-4">
          <div>
            <h3 className="text-lg sm:text-xl font-semibold mb-2">Conformité WCAG 2.1 AAA</h3>
            <ul className="list-disc list-inside space-y-1 sm:space-y-2 text-sm sm:text-base text-gray-700 dark:text-gray-300">
            ...
            <p className="text-xs sm:text-sm mt-2 sm:mt-3 text-ocean-blue font-semibold">
              Essentiel pour patients âgés et personnes handicapées (60% utilisateurs santé &gt;50 ans)
            </p>
          </div>
          <div>
            <h3 className="text-lg sm:text-xl font-semibold mb-2">Fonctionne sur Réseaux 2G</h3>
          ...
          <div>
            <h3 className="text-lg sm:text-xl font-semibold mb-2">Support Multi-Langue</h3>
            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300">
      ...
      <section className="mb-8 sm:mb-12 bg-gradient-to-br from-sea-green/10 to-ocean-blue/10 p-4 sm:p-6 md:p-8 rounded-2xl">
        <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
          <span className="text-lg sm:text-xl md:text-2xl font-bold text-sea-green px-2 sm:px-3 py-1 bg-white dark:bg-gray-800 rounded">RGPD</span>
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold">Responsabilité Éthique</h2>
        </div>
        <div className="space-y-3 sm:space-y-4">
          <div>
            <h3 className="text-lg sm:text-xl font-semibold mb-2">Zéro Tracking & Privacy First</h3>
            <ul className="list-disc list-inside space-y-1 sm:space-y-2 text-sm sm:text-base text-gray-700 dark:text-gray-300">
          ...
          <div>
            <h3 className="text-lg sm:text-xl font-semibold mb-2">Code Source Ouvert</h3>
            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 mb-2">
            ...
            <div className="mt-3 sm:mt-4">
              <Link
                href="/learn"
                className="inline-flex items-center gap-2 bg-ocean-blue text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg hover:bg-ocean-blue/90 transition-colors text-sm sm:text-base"
              >
          ...
          <div>
            <h3 className="text-lg sm:text-xl font-semibold mb-2">Stack Technologique</h3>
            <p className="text-sm sm:text-base text-gray-700 dark:text-gray-300 mb-2">
              Technologies modernes, efficaces et maintenues:
            </p>
            <ul className="list-disc list-inside space-y-0.5 sm:space-y-1 text-sm sm:text-base text-gray-700 dark:text-gray-300">
      ...
      {/* Data Usage */}
      <section className="mb-8 sm:mb-12 bg-white dark:bg-gray-800 p-4 sm:p-6 md:p-8 rounded-2xl shadow-md">
        <h2 className="text-2xl sm:text-3xl font-bold mb-3 sm:mb-4">Utilisation Transparente des Données</h2>
        <div className="space-y-3 sm:space-y-4 text-sm sm:text-base text-gray-700 dark:text-gray-300">
          <div>
            <h3 className="text-lg sm:text-xl font-semibold mb-2">Ce Que Nous Stockons Localement (localStorage)</h3>
          ...
          <div>
            <h3 className="text-lg sm:text-xl font-semibold mb-2">Ce Que Nous Ne Faisons JAMAIS</h3>
            <ul className="list-disc list-inside space-y-0.5 sm:space-y-1">
      ...
      <div className="text-center px-4">
        <h2 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">Questions sur Notre Approche?</h2>
        ...
        <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4">
          <Link
            href="/accessibility"
            className="bg-ocean-blue text-white px-4 sm:px-6 py-2 sm:py-3 rounded-lg hover:bg-ocean-blue/90 transition-colors text-sm sm:text-base"
          >
            Fonctionnalités Accessibilité
          </Link>
          <Link
            href="/learn"
            className="border-2 border-ocean-blue text-ocean-blue px-4 sm:px-6 py-2 sm:py-3 rounded-lg hover:bg-ocean-blue/10 transition-colors text-sm sm:text-base"
          >
